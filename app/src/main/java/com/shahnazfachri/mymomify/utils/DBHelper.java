package com.shahnazfachri.mymomify.utils;
...
public class DBHelper {
    ...
    public void putList(String key, ArrayList<String> marray) {
        SharedPreferences.Editor editor = sharedPreferences.edit();
        String[] mystringlist = marray.toArray(new String[0]);
        editor.putString(key, TextUtils.join("‚‗‚", mystringlist));
        editor.apply();
    }

    public ArrayList<String> getList(String key) {
        String[] mylist = TextUtils.split(sharedPreferences.getString(key, ""), "‚‗‚");
    ...
    public void putListHashMap(String KEY, ArrayList<HashMap<String, String>> marray) {
        String result = new Gson().toJson(marray);
    ...
    public void putListInt(String key, ArrayList<Integer> marray) {
        SharedPreferences.Editor editor = sharedPreferences.edit();
        Integer[] mystringlist = marray.toArray(new Integer[0]);
        editor.putString(key, TextUtils.join("‚‗‚", mystringlist));
        editor.apply();
    }
